...
window.DB.brands = {
  ...
  suzuki: {
    ...
    // Team yellow. Deepened slightly for light mode so small accent text still
    // reads on white; full-brightness Suzuki yellow in dark mode.
    accentLight: "#D99400",
    accentDark: "#FFC72C",
    inkOn: "#1A1205",                  // near-black ink on yellow
